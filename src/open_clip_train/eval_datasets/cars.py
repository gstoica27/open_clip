...
# LOCATION = "/gscratch/krishna/gstoica3/datasets/cars"
LOCATION = "/weka/prior-default/georges/research/MergedVisionEncoders/datasets/stanford_cars"
...
def prepare_test_loaders(config):
    ...
    if not verify_labels('cars', loaders['class_names']):
        pdb.set_trace
    return loaders
